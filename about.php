		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-12 col-sm-6">
					<h2 style="color:aliceblue; z-index:2;"> About Us </h2>
					<p>Welcome to BulkBois! We are a community-focused fitness center dedicated to helping
						you reach your goals. With cutting-edge facilities, experienced trainers, and a range
						of programs, we provide an exceptional fitness experience. Our vision is to inspire and
						support individuals in leading healthier lives. From state-of-the-art equipment to
						personalized workout plans, we have everything you need to succeed. Join our vibrant
						community and enjoy additional amenities like dietpro. Take the first step towards a
						healthier future and join Our Gym today! Your goals are our priority.</p>
				</div>
			</div>
		</div>
	</section>
