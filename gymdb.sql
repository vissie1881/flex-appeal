...
(2, 'igloo', 'god@varsha.com', '9558458562', 'e63509db9895a44dcae67bf5d79ec9b6', '2023-05-13 15:55:08');
...
CREATE TABLE `tbltrainer` (
  ...
  `avlbl_sun` varchar(3) NOT NULL DEFAULT 'NO',
  `avlbl_mon` varchar(3) NOT NULL DEFAULT 'NO',
  `avlbl_tue` varchar(3) NOT NULL DEFAULT 'NO',
  `avlbl_wed` varchar(3) NOT NULL DEFAULT 'NO',
  `avlbl_thu` varchar(3) NOT NULL DEFAULT 'NO',
  `avlbl_fri` varchar(3) NOT NULL DEFAULT 'NO',
  `avlbl_sat` varchar(3) NOT NULL DEFAULT 'NO'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(7, 'Puvis', 'K', 'puvis@puvis.com', '7305256503', '0f249642a94cb537ccb459bb1b6630e9', 'Tamil Nadu', 'Erode', '56, 4th street,', '2023-05-13 12:43:05');
