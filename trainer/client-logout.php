...
$sql = "INSERT INTO tblsession (client_id, logout_time) VALUES (:id, :currentDateTime)";
            ...
            <div class="tile-body">
              <table class="table table-hover table-bordered" id="sampleTable">
                <thead>
                  ...
                  <?php
                  $sql="select s.id as id,u.fname as fname from tblsession s join tbluser u on s.client_id=u.id where s.logout_time is NULL and u.trainer_id=:trainer";
                  $query= $dbh->prepare($sql);
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <a href="client-logout.php?mark=<?php echo htmlentities($result->id);?>"><button class="btn btn-danger" type="button">logout</button></a></td>
                  </tr>
                    <?php  } } ?>
